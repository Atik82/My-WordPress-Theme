...
add_action('after_setup_theme','atik_theme_support');
...
function my_add_theme_scripts() {
	...
	wp_enqueue_script( 'backtotop', get_template_directory_uri() . '/assets/js/backtotop.js', array('jquery'), '1.1', true );
	...
	wp_enqueue_script( 'vanilla-tilt', get_template_directory_uri() . '/assets/js/vanilla-tilt.js', array("imagesloaded"), '1.1', true );
